"""
A2_6 — plot ensemble DVHs with ±1σ shaded bands for the SOBP proton plan.

Reads ``A2_6/outputs/uncertainty/aggregated.npz`` (produced by
...
Usage:
    python3 A2_6/analyse_dvh_uncertainty.py
"""
...
AGG_PATH    = os.path.join(SCRIPT_DIR, "outputs", "uncertainty", "aggregated.npz")
OUTPUT_PATH = os.path.join(SCRIPT_DIR, "outputs", "dvh_sobp_uncertainty.png")
...
def main():
    if not os.path.isfile(AGG_PATH):
        ...
        print("Run A2_6/run_uncertainty.py first.")
        return
    ...
    title = "Cumulative DVHs — SOBP Proton Plan"
    if n_replicates:
