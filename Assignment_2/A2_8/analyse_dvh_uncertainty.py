"""
A2_8 — plot ensemble DVHs with ±1σ shaded bands for the PBS proton plan.

Reads ``A2_8/output/uncertainty/aggregated.npz`` (produced by
...
Usage:
    python3 A2_8/analyse_dvh_uncertainty.py
"""
...
OUTPUT_PATH = os.path.join(SCRIPT_DIR, "output", "dvh_pbs_uncertainty.png")
...
def main():
    if not os.path.isfile(AGG_PATH):
        ...
        print("Run A2_8/run_uncertainty.py first.")
        return
    ...
    title = "Cumulative DVHs — PBS Proton Plan"
    if n_replicates:
